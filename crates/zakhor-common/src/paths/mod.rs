...
//! - one-time best-effort migration of legacy model caches into the shared dir.
//!
...
pub use migrate::{
    MigrationReport, copy_dir_recursive, legacy_model_cache_sources, migrate_legacy_model_caches,
};
pub use xdg::{
